...
export const DEVICES: Device[] = [
  ...
  { key: 'ge-logic-s8', label: 'GE LOGIQ S8 Ultrasound', labelNo: 'GE LOGIQ S8 ultralydapparat', quantity: 1 },
...
const EQUIPMENT_MATCHERS: Array<{ pattern: RegExp; device: string }> = [
  ...
  // GE's product is the LOGIQ S8; the labs long carried the misspelling "Logic S8",
  // so match either rather than silently losing the capacity check.
  { pattern: /LOGI[QC]\s*S8/i, device: 'ge-logic-s8' },
