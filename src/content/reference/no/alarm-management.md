...
ECRI Institute rangerte alarmfarer som **den fremste helseteknologiske faren** på Top 10-listene for 2012–2015 — senere utgaver toppes av andre farer, så oppgi alltid årstall når du viser til denne rangeringen. The Joint Commission har utgitt et nasjonalt pasientsikkerhetsmål spesifikt rettet mot alarmhåndtering.
...
I tillegg genererer utstyr **tekniske alarmtilstander** for utstyrsproblemer (løs elektrode, lavt batteri, sensorfeil). IEC 60601-1-8 regner disse som fullverdige alarmtilstander med de samme tre prioritetsnivåene som fysiologiske alarmtilstander — løs avledning under overvåking for asystoli er en *høyprioritert* teknisk alarm, ikke en ren melding. De må ikke forveksles med *informasjonssignaler*, som standarden definerer som signaler som **ikke** er alarmsignaler. Motstykket til en teknisk alarmtilstand er en *fysiologisk alarmtilstand*, altså en alarm utledet av en pasientparameter.
...
- **Algoritmejustering:** Arytmisensitivitet, SpO₂-midlingstid, deteksjon av løse avledninger
...
| **SpO₂ lav (artefakt)** | Probe løs, lav perfusjon, bevegelse | Bedre probeposisjonering; bruk bevegelsestolerant SpO₂-teknologi |
| **Arytmi (VES)** | Hyppige VES hos hjertepasienter | Reduser VES-varslingssensitivitet; sett VES/min-grense |
| **EKG-avledning løs** | Sviktende elektrodefeste | Daglig elektrodeskift; bruk elektroder med høy klebeevne for svettende pasienter |
...
### Dataanalyse
- Hente og analysere alarmloggdata for å identifisere de største alarmkildene
...
- Sikre at EKG-kabler, elektroder og SpO₂-sensorer er i god stand
...
- Informere om forskjellen mellom fysiologiske (pasientrelaterte) og tekniske alarmer
...
| **ECRI Institute** | Topp 10 helseteknologiske farer — alarmrelaterte farer |
